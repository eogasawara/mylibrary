...
30-ts-mlp.py
------------
Time series regression with an MLP over sliding windows.
Loads training/testing CSVs from pytorch/data and demonstrates
...
if __name__ == "__main__":
    # Example usage: Train and evaluate on timeseries data windows
    import pandas as pd
    ...
    preds = predict_torch_mlp(model, df_test)
    print(preds)
